    ...
    <div class="container" id="signIn">
        <div class="row justify-content-center mt-3">
            <div class="col-12 text-center mb-4">
                <img src="img/css.jpg" class="rounded-circle" style="width: 150px; height: 150px;"
                    alt="Logo">
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <h3 class="form-title text-center">College of Computer Studies</h3>
                <form method="post" action="process.php">
                    ...
                    <div class="text-center mt-3">
                        <h6><a class="btn btn-success" href="admin_register.php">Create account</a></h6>
                    </div>
                </form>
            </div>
        </div>
